...
| Directory | Component |
|---|---|
| `validation-engine/` | Export validation & document generation (FastAPI) |
| `voice-pipeline/` | Voice pipeline (placeholder) |
| `pricing-engine/` | Pricing engine (placeholder) |
| `tracking-api/` | Tracking API (placeholder) |
| `frontend/` | Frontend (placeholder, nginx:alpine) |
...
| validation-engine | 8001 | 8000 | FastAPI dev server |
| voice-pipeline | 8002 | 8000 | Placeholder |
...
| validation-engine | TBD — validation-engine owner | Existing codebase (post-migration) |
| voice-pipeline | TBD — voice-pipeline owner | Placeholder until ML model scope |
