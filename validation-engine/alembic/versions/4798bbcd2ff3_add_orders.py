...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('quote_accepted', 'confirmed', 'paid_held', 'in_transit', 'delivered', 'disputed', 'settled', 'refunded', name='order_status'), nullable=False),
    sa.Column('validation_state', sa.Enum('incomplete', 'invalid', 'ready', name='validation_state'), nullable=True),
